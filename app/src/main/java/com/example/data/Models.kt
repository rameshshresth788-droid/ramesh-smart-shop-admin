...
data class StaffAdmin(
    ...
    val has_gemini_key: Boolean = false
)

/** Body for POST api/admin/staff/index.php (approve/reject/disable/enable). */
@JsonClass(generateAdapter = true)
...
/** Body for PUT api/admin/staff/index.php?id=N - only non-null fields are changed. */
@JsonClass(generateAdapter = true)
